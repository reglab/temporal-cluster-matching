...
dataset_list="../all_buildings/data/input/compare_models/miami.geojson ../all_buildings/data/input/compare_models/miami.geojson ../all_buildings/data/input/compare_models/miami.geojson ../all_buildings/data/input/compare_models/miami.geojson ../all_buildings/data/input/compare_models/miami.geojson ../all_buildings/data/input/compare_models/miami.geojson
"
cluster_list="16 16 16 32 32 32
"
buffer_list="0.001 0.0005 0.0001 0.001 0.0005 0.0001
"
output_dir_list="../all_buildings/data/output/compare_models/miami_16_0.001/ ../all_buildings/data/output/compare_models/miami_16_0.0005/ ../all_buildings/data/output/compare_models/miami_16_0.0001/ ../all_buildings/data/output/compare_models/miami_32_0.001/ ../all_buildings/data/output/compare_models/miami_32_0.0005/ ../all_buildings/data/output/compare_models/miami_32_0.0001/
"
